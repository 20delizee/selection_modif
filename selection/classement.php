        ...
        ?>
<?php
if(isset($_GET['modif_grille'])){
    
    header('Location: modif_grille.php/?id=' . $_GET['modif_grille'] .'');
}
?>
<br>
...
<html lang="fr">
	...
	<body>
    <a href="prof.php">Retour accueil PROF</a>
    ...
    <br/>
        <table>
            ...
            <tr>
                <td>
                    <form method="GET">
                        <input type="hidden" name="modif_grille" value="<?php echo $data['id'];?>" />
